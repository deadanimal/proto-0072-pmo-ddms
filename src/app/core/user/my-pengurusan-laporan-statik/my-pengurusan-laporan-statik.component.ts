...
@Component({
  selector: "app-my-pengurusan-laporan-statik",
  templateUrl: "./my-pengurusan-laporan-statik.component.html",
  styleUrls: ["./my-pengurusan-laporan-statik.component.scss"],
})
export class MyPengurusanLaporanStatikComponent implements OnInit, OnDestroy {
  // Chart
  chart: any;
  chart1: any;
  chart2: any;
  ...
  getChart() {
    let chart = am4core.create("chartMyStatic1", am4charts.XYChart);
  ...
  getChart2() {
    ...
    let chart = am4core.create("chartMyStatic2", am4charts.XYChart);
    chart.colors.step = 2;
  ...
  getChart3() {
    ...
    let chart = am4core.create("chartMyStatic3", am4charts.PieChart);
    chart.hiddenState.properties.opacity = 0; // this creates initial fade-in
