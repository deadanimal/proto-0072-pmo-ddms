...
@Component({
  selector: "app-pengurusan-forum",
  templateUrl: "./pengurusan-forum.component.html",
  styleUrls: ["./pengurusan-forum.component.scss"],
})
export class PengurusanForumComponent implements OnInit, OnDestroy {
  // Table
