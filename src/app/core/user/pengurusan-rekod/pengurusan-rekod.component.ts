...
@Component({
  selector: "app-pengurusan-rekod",
  templateUrl: "./pengurusan-rekod.component.html",
  styleUrls: ["./pengurusan-rekod.component.scss"],
})
export class PengurusanRekodComponent implements OnInit, OnDestroy {
  imgPdf = "assets/img/default/soal_selidik.jpg";
  ...
  openLgModal(modalRef: TemplateRef<any>) {
    // if (row) {
    //   console.log(row);
    //   this.editActionForm.patchValue(row);
    // }
  ...
  getChart() {
    ...
    let chart = am4core.create("chartdivRekod", am4charts.XYChart);
