...
@Component({
  selector: "app-pengurusan-folder",
  templateUrl: "./pengurusan-folder.component.html",
  styleUrls: ["./pengurusan-folder.component.scss"],
})
export class PengurusanFolderComponent implements OnInit, OnDestroy {
  // Table
  ...
  listFolder: any = [
    {
      id: "415796",
      folder: "Folder 1",
      description: "Keterangan Folder 1",
      created_at: "2019-07-27T01:07:14Z",
    },
    {
      id: "415796",
      folder: "Folder 2",
      description: "Keterangan Folder 2",
      created_at: "2019-07-27T01:07:14Z",
    },
    {
      id: "415796",
      folder: "Folder 3",
      description: "Keterangan Folder 3",
      created_at: "2019-07-27T01:07:14Z",
    },
  ];
  ...
  navigatePage(path: String) {
    ...
    // console.log(path + "/" + id);
    if (path == "/user/ruang-kerja-digital/pengurusan-sub-folder") {
      return this.router.navigate([path]);
    }
  }

  getAction(id: string): Action[] {
    return this.listAction.find((e) => e.id === id);
  }
