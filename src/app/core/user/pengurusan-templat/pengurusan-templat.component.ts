...
@Component({
  selector: "app-pengurusan-templat",
  templateUrl: "./pengurusan-templat.component.html",
  styleUrls: ["./pengurusan-templat.component.scss"],
})
export class PengurusanTemplatComponent implements OnInit, OnDestroy {
  // Table
