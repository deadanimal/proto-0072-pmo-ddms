...
@Component({
  selector: "app-pengurusan-analitik",
  templateUrl: "./pengurusan-analitik.component.html",
  styleUrls: ["./pengurusan-analitik.component.scss"],
})
export class PengurusanAnalitikComponent implements OnInit, OnDestroy {
  // Table
