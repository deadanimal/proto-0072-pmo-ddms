...
@Component({
  selector: "app-pengurusan-promosi",
  templateUrl: "./pengurusan-promosi.component.html",
  styleUrls: ["./pengurusan-promosi.component.scss"],
})
export class PengurusanPromosiComponent implements OnInit, OnDestroy {
  // Table
