...
@Component({
  selector: "app-pengurusan-aplikasi",
  templateUrl: "./pengurusan-aplikasi.component.html",
  styleUrls: ["./pengurusan-aplikasi.component.scss"],
})
export class PengurusanAplikasiComponent implements OnInit, OnDestroy {
  // Table
