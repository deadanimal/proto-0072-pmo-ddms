...
@Component({
  selector: "app-pengurusan-pendaftaran-aduan",
  templateUrl: "./pengurusan-pendaftaran-aduan.component.html",
  styleUrls: ["./pengurusan-pendaftaran-aduan.component.scss"],
})
export class PengurusanPendaftaranAduanComponent implements OnInit, OnDestroy {
