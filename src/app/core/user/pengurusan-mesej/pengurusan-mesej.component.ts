...
@Component({
  selector: "app-pengurusan-mesej",
  templateUrl: "./pengurusan-mesej.component.html",
  styleUrls: ["./pengurusan-mesej.component.scss"],
})
export class PengurusanMesejComponent implements OnInit, OnDestroy {
  imgPdf = "/src/assets/img/default/profile.png";
