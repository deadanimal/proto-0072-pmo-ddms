...
@Component({
  selector: "app-pengurusan-halaman",
  templateUrl: "./pengurusan-halaman.component.html",
  styleUrls: ["./pengurusan-halaman.component.scss"],
})
export class PengurusanHalamanComponent implements OnInit, OnDestroy {
  // Table
