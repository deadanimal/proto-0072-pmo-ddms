...
@Component({
  selector: "app-pengurusan-kalendar",
  templateUrl: "./pengurusan-kalendar.component.html",
  styleUrls: ["./pengurusan-kalendar.component.scss"],
})
export class PengurusanKalendarComponent implements OnInit {
  addModal: BsModalRef;
