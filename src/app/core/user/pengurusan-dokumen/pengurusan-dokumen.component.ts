...
export class PengurusanDokumenComponent implements OnInit, OnDestroy {
  imgword = "assets/img/default/ex_2.png";
  imgPptx = "assets/img/default/ex_3.jpg";
  imgcsv = "assets/img/default/ex_4.jpg";
