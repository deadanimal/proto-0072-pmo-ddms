...
@Component({
  selector: "app-pengurusan-email",
  templateUrl: "./pengurusan-email.component.html",
  styleUrls: ["./pengurusan-email.component.scss"],
})
export class PengurusanEmailComponent implements OnInit, OnDestroy {
  // Table
  ...
  files: File[] = [];
  imgPdf = "assets/img/default/profile.png";
