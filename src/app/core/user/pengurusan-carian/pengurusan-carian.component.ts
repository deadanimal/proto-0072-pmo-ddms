...
@Component({
  selector: "app-pengurusan-carian",
  templateUrl: "./pengurusan-carian.component.html",
  styleUrls: ["./pengurusan-carian.component.scss"],
})
export class PengurusanCarianComponent implements OnInit, OnDestroy {
  // Table
