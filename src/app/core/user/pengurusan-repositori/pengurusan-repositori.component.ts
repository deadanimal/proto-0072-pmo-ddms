...
@Component({
  selector: "app-pengurusan-repositori",
  templateUrl: "./pengurusan-repositori.component.html",
  styleUrls: ["./pengurusan-repositori.component.scss"],
})
export class PengurusanRepositoriComponent implements OnInit, OnDestroy {
  // Table
