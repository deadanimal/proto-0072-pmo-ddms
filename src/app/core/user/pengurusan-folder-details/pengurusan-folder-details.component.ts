...
@Component({
  selector: "app-pengurusan-folder-details",
  templateUrl: "./pengurusan-folder-details.component.html",
  styleUrls: ["./pengurusan-folder-details.component.scss"],
})
export class PengurusanFolderDetailsComponent implements OnInit, OnDestroy {
  // Table
